 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ky(t=da()){const e=Or(t,"auth");return e.isInitialized()?e.getImmediate():qg(t,{popupRedirectResolver:Sy,persistence:[Mm,zu,Wu]})}Ay("Browser");function Py(){const e=_h({apiKey:"AIzaSyAdg24vyh37b8k7Odw1lm537H823T5b7j8",authDomain:"feelings-b4f50.firebaseapp.com",projectId:"feelings-b4f50",storageBucket:"feelings-b4f50.appspot.com",messagingSenderId:"163419273883"});return Cg(e)}async function Ly(){const t=ky();return vm(t,zu).then(async()=>{if(t.currentUser!==null)return t.currentUser;const e=await Wm(t);if(e!==null)return e.user;await zm(t,new me)})}export{Sg as D,My as E,Oy as T,Ry as V,Py as i,Ly as l,Ny as y};
